...
if __name__ == "__main__":
    import os
    # Get the dynamic port provided by Render, or default to 8000 on your local computer
    port = int(os.environ.get("PORT", 8000))
    # Using 0.0.0.0 allows it to be accessed from the public internet on Render
